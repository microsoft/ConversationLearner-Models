...
var ExtractResponse = (function () {
    ...
    tslib_1.__decorate([
        json_typescript_mapper_1.JsonProperty({ clazz: AppDefinition_1.AppDefinition, name: 'definitions' }),
        tslib_1.__metadata("design:type", AppDefinition_1.AppDefinition)
    ], ExtractResponse.prototype, "definitions", void 0);
