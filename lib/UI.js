...
var UITrainScorerStep = (function () {
    function UITrainScorerStep(init) {
        this.trainScorerStep = undefined;
        this.entities = undefined;
        Object.assign(this, init);
    }
    tslib_1.__decorate([
        json_typescript_mapper_1.JsonProperty({ clazz: TrainDialog_1.TrainScorerStep, name: 'trainScorerStep' }),
        tslib_1.__metadata("design:type", TrainDialog_1.TrainScorerStep)
    ], UITrainScorerStep.prototype, "trainScorerStep", void 0);
    tslib_1.__decorate([
        json_typescript_mapper_1.JsonProperty({ clazz: Entity_1.EntityBase, name: 'entities' }),
        tslib_1.__metadata("design:type", Array)
    ], UITrainScorerStep.prototype, "entities", void 0);
    return UITrainScorerStep;
}());
exports.UITrainScorerStep = UITrainScorerStep;
