...
var UIScoreResponse = (function () {
    ...
    tslib_1.__decorate([
        json_typescript_mapper_1.JsonProperty({ clazz: ScoreResponse, name: 'scoreResponse' }),
        tslib_1.__metadata("design:type", ScoreResponse)
    ], UIScoreResponse.prototype, "scoreResponse", void 0);
    tslib_1.__decorate([
        json_typescript_mapper_1.JsonProperty({ clazz: ScoreInput, name: 'scoreInput' }),
        tslib_1.__metadata("design:type", ScoreInput)
